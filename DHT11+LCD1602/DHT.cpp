...
DHT::DHT(uint8_t type) {
    if (_type != DHT10){
        Serial_PRINT("Error : No pins are defined\n");
    }
    _pin = 0;
    _type = type;
    _count = COUNT;
...
boolean DHT::read(void) {
    ...
    firstreading = false;
    /*
        Serial_PRINT("Currtime: "); Serial_PRINT(currenttime);
        Serial_PRINT(" Lasttime: "); Serial_PRINT(_lastreadtime);
    */
    ...
    /*
        Serial_PRINTln(j, DEC);
        Serial_PRINT(data[0], HEX); Serial_PRINT(", ");
        Serial_PRINT(data[1], HEX); Serial_PRINT(", ");
        Serial_PRINT(data[2], HEX); Serial_PRINT(", ");
        Serial_PRINT(data[3], HEX); Serial_PRINT(", ");
        Serial_PRINT(data[4], HEX); Serial_PRINT(" =? ");
        Serial_PRINTln(data[0] + data[1] + data[2] + data[3], HEX);
    */
